  ...
  renderQuestions() {
    if (this.props.form == null) {
      ...
      return this.props.form.questions.map((question, i) => (
        <FormGroupShow question={question} index={i} />
      ));
    }
  }
      ...
      <div className="form-body">
        <Container text>
          <Modal
            centered={false}
            dimmer="inverted"
            open={this.props.formSubmitStatus.formSubmitStatus}
          >
            <Header as="h2">
              <Icon size="big" color="green" name="check circle outline" />{" "}
              Submssion Successful!
            </Header>
